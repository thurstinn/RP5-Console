...
pwmPin = 12      #Pin with PWM capability please reference https://pinout.xyz/pinout/pin33_gpio13
tachoPin = 16     #Pin where the tacho is plugged in
desiredTemp = 52
maxTemp = 70     #At this temperature the fan will run at 100%
threshold = 30   #Percentage threshold how low the fan can run. 15 works for Noctua A4x10. Other fans need to be checked
...
rpmFilePath = "/var/log/fan.rpm" #Path to where a file with the rpm number should be saved. So other apps can access it.
